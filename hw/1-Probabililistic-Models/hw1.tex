...
\begin{question}
Suppose I have a dataset with the following variables:
\begin{itemize}[noitemsep]
    ...
    \item $D$: a binary variable indicating whether the average commute delay is more than 10 minutes.
\end{itemize}
...
\begin{enumerate}[label=(\alph*)]
    \item Which distribution has fewer independent parameters?
    \item Suppose you are an app developer who wants to warn users how likely it is that they will be delayed based on the temperature and snow history. Your data scientist gives you a model in the form on the right. How do you respond?
\end{enumerate}
...
\begin{question}
    Write a function in Julia that takes in two arguments and uses the Pythagorean Theorem to compute the hypotenuse of a right triangle with side lengths specified. Submit this function with \texttt{DMUStudent.submit}. \footnote{This particular "Challenge Problem" is not meant to be challenging; it is meant to test that everyone can download the code and submit. Future problems in this section will be quite challenging.}
\end{question}
