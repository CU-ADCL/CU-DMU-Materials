...
A submission should consist of one or two files:
\begin{itemize}[nosep]
...
\begin{question}
    (25 pts) Consider a 3-armed Bernoulli Bandit with payoff probabilities $\theta = [0.2, 0.3, 0.7]$.
...
\begin{question}
    (40 pts) Implement \textbf{two} tabular or deep learning algorithms to learn a policy for the \texttt{DMUStudent.HW4.gw} grid world environment.     You will submit the following deliverables:
