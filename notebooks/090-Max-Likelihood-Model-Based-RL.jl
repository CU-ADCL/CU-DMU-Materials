...
# ╔═╡ 4fa6316b-8ff2-4fbf-804c-0aab70bc2024
begin
...
# ╔═╡ b8a6ec02-1f2b-4271-8037-7a051b36577b
md"""
# Interacting with CommonRLInterface Environments
"""

# ╔═╡ c6ead762-1977-4b87-a48d-72243b9b8b89
m = SimpleGridWorld(tprob=0.9)

# ╔═╡ 2214b697-b4f5-4898-a1de-f94ddef04b8b
env = convert(AbstractEnv, m)

# ╔═╡ 0a80b329-9aac-4e05-b728-05eea38e901c
...
# ╔═╡ 0e6434a2-0603-464d-815e-b08809357aac
render(env)

# ╔═╡ 30f52e39-c5cc-4f97-83c4-f4c7f405bb6a
actions(env)

# ╔═╡ fa16d37b-e164-40d0-98e9-42334955f6da
act!(env, :up) # returns reward

# ╔═╡ 2514afa9-56fa-4499-8c95-3474425bffdf
observe(env)

# ╔═╡ 6e4545ec-08e2-407f-9a32-feb0d6e024ab
render(env)

# ╔═╡ 37d52b53-3c4b-4be9-a236-3d2bca1fadd6
terminated(env)

# ╔═╡ 35eeeafe-450b-4e43-90d3-73b2b2cc07d2
reset!(env)

# ╔═╡ e7a18cfe-904f-4f1e-aaf4-ec80af3c5b87
observe(env)
...
episodes, index = max_likelihood_model_based_rl!(env, n_episodes=100)

# ╔═╡ 6303a96b-b904-4c5f-b8e7-6e6a76bb0f4a
@bind episode Select(1:length(episodes))

# ╔═╡ a81e175d-b8f7-40c8-ab15-2e7fb015681f
@bind step Slider(1:maximum(ep->length(ep.hist), episodes))

# ╔═╡ 6a0cf19a-06d5-4084-b2da-3a519cf0ed14
begin
	    ep = episodes[episode]
...
# ╔═╡ cdf7eb8e-b0cf-4386-85f9-c0cbbd87044d
...
manifest_format = "2.0"
project_hash = "c337c8eda1fb3d88fb5a0631387b4037de2cb749"
