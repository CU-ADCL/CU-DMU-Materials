...
# ╔═╡ 6d0d3205-f658-44bf-95b5-a8eb9a43a08c
begin
	using POMDPs
...
# ╔═╡ 86c25e74-4e93-4ef1-9ada-a3deb7c14279
md"""
# Scalar LQR MDP

$$s' = s + 0.2\, a + 0.1 \, w$$

where $w$ normally distributed.

$$R(s, a) = -s^2$$

"""

# ╔═╡ 34d2b346-2ed9-4bab-8323-0ee117cfd950
lqr = QuickMDP(
	statetype=Float64,
	actiontype=Float64,
...
# ╔═╡ af462154-bf17-4723-a870-51fcebb466d1
md"""
## Hand Tuning

We know that $\pi^*(s) = -k s$ for some $k$.
"""

# ╔═╡ bb9c09f3-5d8c-44da-8ebe-8f5288ef15ff
@bind k Slider(-10:2:16, default=0)

# ╔═╡ 60b53bbb-2791-4e2f-8113-db8f09a16f5a
begin
...
# ╔═╡ c47f5dbb-c0a4-46ff-b750-5237e425f241
md"""
## Monte Carlo Evaluation
"""

# ╔═╡ 879b561a-65c3-4afb-8519-bbd8384ce7c3
...
# ╔═╡ 80898b02-8dfb-40cd-bb55-41fe11196f38
md"""
# Cross-Entropy Optimization
"""

# ╔═╡ a121ace1-bf21-4f90-9d47-951d6a934536
begin
	plots = []
	...
	for _ in 1:100
		...
		plot!(xlabel="k", ylabel="Avg. return (MC evaluation)")
	    push!(plots, p)
	end
end

# ╔═╡ 4ec81ecd-8ad0-4e7c-8e36-251cb15221a8
@bind i Select(1:length(plots))

# ╔═╡ f87849d5-9a7c-48c2-a5c5-32aa573ec48c
plots[i]

# ╔═╡ 9b7ddbad-23c4-4cb0-917d-f615ec20547b
...
manifest_format = "2.0"
project_hash = "14fac1d3da32639cc50fe32c32a10f02cf4ca917"
