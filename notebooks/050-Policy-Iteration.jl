...
# ╔═╡ b14f2961-2db3-46a0-8ea6-2fad1b70ecdd
begin
	using POMDPs
...
# ╔═╡ c9375fa1-4e35-42b0-ada9-eb16158c8f33
function policy_iteration(m)
    ...
    new_p = VectorPolicy(m, fill(first(A), n))
    pv_history = []
...
# ╔═╡ 16a89003-363d-4c8f-9650-8360d848528f
pv_history = policy_iteration(m);

# ╔═╡ f81a4591-2154-4bb0-887f-bad8e786366b
@bind t Slider(1:length(pv_history))

# ╔═╡ ef7f9e8d-15c1-4df4-9915-7403bce26017
begin
	p,v = pv_history[t]
	render(m, policy=p)
end

# ╔═╡ 9b21f5e7-fa00-4d7f-b757-263e6fe70e00
render(m, color=v, policy=p)

# ╔═╡ b70cb497-564d-4c12-968b-305ab6e62224


# ╔═╡ 20b6ad76-1c98-4a42-a73b-d96126cadbe8
...
manifest_format = "2.0"
project_hash = "38ac2e74eb02f6b10f718a909b3bcabc6d021082"
