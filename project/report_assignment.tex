...
% XXX TODO (2027): In gradescope, assign all pages to each question except required items
...
\begin{itemize}
    \item \textbf{Project Design and Scope} (10 pts): Was the project appropriately designed and scoped for the course? Does the project match what was outlined in the proposal? \textbf{\color{purple}If the direction of the final product has changes from the proposal, clearly explain how and why.}
    \item \textbf{Project Execution} (30 pts): Did the project accomplish the main goals outlined in the proposal? If not, did the project at least accomplish the minimum working example? Were the DMU methods effective in solving the problem?
